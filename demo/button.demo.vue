...
<template>
  <b-config-provider :theme="theme" class="p16">
    <div class="demo-button">
      <b-button type="primary" @click="theme = 'dark'">深色</b-button>
      <b-button @click="theme = null">浅色</b-button>
    </div>
    ...
    <div class="test-wrap">
      <div class="demo-button">
        ...
        <b-button-group>
          <b-button type="success" icon="star" />
          <b-button type="info" icon="heatmap" />
          <b-button type="danger" icon="edit" />
        </b-button-group>
