import{_ as l,c as p,O as o,X as n,k as s,K as e,o as t}from"./chunks/framework.ef1b8cce.js";const m=JSON.parse('{"title":"通用样式","description":"","frontmatter":{"title":"通用样式"},"headers":[],"relativePath":"docs/common-css.md","filePath":"docs/common-css.md"}'),c={name:"docs/common-css.md"},r=n(`<h1 id="通用样式" tabindex="-1">通用样式 <a class="header-anchor" href="#通用样式" aria-label="Permalink to &quot;通用样式&quot;">​</a></h1><p>组件内部导入了部分通用样式，如内外边距，flex等。默认全局样式引入的时候会默认导入，如进行按需加载，部分内容可按需进行导入</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki rose-pine-moon vp-code-dark"><code><span class="line"><span style="color:#908CAA;font-style:italic;">//</span><span style="color:#6E6A86;font-style:italic;"> main.ts</span></span>
...
<span class="line"><span style="color:#002339;">}</span></span></code></pre></div>`,9),y=s("div",{flex:"main:center cross:center",style:{height:"80px",border:"1px solid #1089ff"}},[s("div",{style:{background:"#fff",padding:"15px"}},"看看我是不是居中的")],-1),i=n(`<div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki rose-pine-moon vp-code-dark"><code><span class="line"><span style="color:#908CAA;font-style:italic;">&lt;!--</span></span>
...
<span class="line"><span style="color:#002339;">}</span></span></code></pre></div>`,9);function A(C,E,D,F,f,d){const a=e("b-back-top");return t(),p("div",null,[o(a),r,y,i])}const g=l(c,[["render",A]]);export{m as __pageData,g as default};
